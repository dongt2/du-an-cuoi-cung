...
@section('content')
    <br><br><br>
    <form id="login-form" class="login" method='post' novalidate='' action="{{ route('login.store') }}">
        @csrf
        ...
        <div class="login__control">
            ...
            <a href="{{ route('register.index') }}" class="login__tracker form__tracker">Bạn chưa có tài khoản? Đăng kí</a>
