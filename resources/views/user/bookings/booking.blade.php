            ...
            @else
                <div class="col-sm-12">
                    <div class="choose-indector choose-indector--film">
                        ...
                        <span id="choosen-movie" class="choosen-area" data-value="{{ $item->movie_id }}"
                            data-film="{{ $item->title }}">
                            {{ $movie->title }}
                        </span>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            bookingForm.addEventListener('submit', function(e) {
                ...
                // kiểm tra nếu không chọn đủ thông tin của bước 1 thì hiển thị thông báo
                if (!movieName || !date || !time) {
                    e.preventDefault();
                    alert('Chưa chọn đủ thôg tin');
                }
            });
        });
    </script>
