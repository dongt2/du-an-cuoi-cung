...
@section('content')
    ...
    <form id='film-and-time' class="booking-form" method='POST' action='{{ route("storestepTwo")}}'>
        @csrf

        <!-- <input type='text' name='choosen-number' class="choosen-number hidden-input "> -->

        <input type='text' name='choosen_number' class="choosen-number">
        <input type='text' name='choosen_number_cheap' class="choosen-number--cheap">
        <input type='text' name='choosen_number_middle' class="choosen-number--middle">
        <input type='text' name='choosen_number_expansive' class="choosen-number--expansive">
        <input type='text' name='choosen_cost' class="choosen-cost">
        <input type='text' name='choosen_sits' class="choosen-sits">

        <div class="booking-pagination booking-pagination--margin">
            {{-- <a href="{{ route('bookingMovie', ['id' => session('bookingStep1')['movie_id']]) }}" class="booking-pagination__prev">
