            ...
            <div class="table-responsive">
                @if (isset($combos) && $combos->isNotEmpty())
                            ...
                            @foreach ($combos as $combo)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <img src="{{ asset('images/combo.png') }}" alt="Combo Image" class="img-thumbnail"
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="input-group quantity-input-group justify-content-center">
                                            ...
                                            <input type="number" id="quantity-{{ $combo['id'] }}"
                                                ...
                                                max="10" value="0" data-id="{{ $combo['id'] }}"
                    ...
                    <div class="text-right mt-3">
                        <h4>Tổng tiền tất cả : <span id="total-price" class="text-danger font-weight-bold">0 VND</span></h4>
                    </div>
                @else
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            decreaseButtons.forEach(button => {
                button.addEventListener('click', function() {
                    const id = this.getAttribute('data-id'); // Lấy ID combo
                    const quantityInput = document.getElementById(`quantity-${id}`);
