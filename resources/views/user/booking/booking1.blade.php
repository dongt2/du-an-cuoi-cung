...
@section('script')
        ...
        function setScreen(screenId, screenName) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if ($.isEmptyObject(response)) { // Kiểm tra nếu response không có xuất chiếu
                        showtimesHtml = '<p>Không có xuất chiếu, vui lòng chọn phòng khác!</p>';
                    } else {
                    ...
                    // Nếu có xuất chiếu, thêm sự kiện click để chọn thời gian
    ...
    <script>
        ...
        // Lắng nghe sự kiện thay đổi ngay lập tức của input movie_id
        document.querySelector('.choosen-movie').addEventListener('input', function() {
            // Reset các ô input khác khi movie_id thay đổi
            document.querySelector('.choosen-screen').value = ''; // Reset screen_id
            document.querySelector('.choosen-cinema').value = ''; // Reset showtime_date
            document.querySelector('.choosen-time').value = ''; // Reset showtime_time
        });
    </script>
