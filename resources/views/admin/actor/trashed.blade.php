                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0"><strong>Danh sách diễn viên đã xóa</strong></h5>
                        </div><!-- end card header -->
                                ...
                                @foreach ($actor as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            <!-- Nút Restore -->
                                            <form action="{{ route('admin.actor.restore', $item->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                            ...
                                            <!-- Nút Force Delete -->
                                            <form action="{{ route('admin.actor.forceDelete', $item->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
