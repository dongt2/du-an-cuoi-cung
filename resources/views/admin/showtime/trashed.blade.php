                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0"><strong>Danh sách xuất chiếu đã xóa</strong></h5>
                        </div><!-- end card header -->
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.showtime.restore', $item->showtime_id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                            ...
                                            <!-- Nút Force Delete -->
                                            <form action="{{ route('admin.showtime.forceDelete', $item->showtime_id) }}" method="POST" style="display: inline-block;">
                                                @csrf
