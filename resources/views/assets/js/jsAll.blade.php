<!-- JavaScript-->
    ...
    <script>
        window.jQuery || document.write('<script src="/template/amovie.gozha.net/js/external/jquery-1.10.1.min.js"><\/script>')
    </script>
    <!-- Migrate -->
    ...
    <script type="text/javascript" src="/template/amovie.gozha.net/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
